...
1. Linear Regression Implementation — sklearn workflow
2. Model Evaluation — R², MAE, MSE, RMSE
3. Residual Analysis — Normality, homoscedasticity
4. Q-Q Plots — Visual normality testing
5. Outlier Detection — Z-score method (threshold = 3)
6. Data Visualization — Seaborn, Matplotlib
7. GitHub Documentation — Clear communication of results
